...
elseif guiCancel == 0
    if strcmp(guiFields.rB_p,'Miller (hkl)[UVW]')
        planeParent = Miller(...
            guiFields.h_p,...
            guiFields.k_p,...
            guiFields.l_p,...
        ...
        directionParent = Miller(...
            ...
            job.csParent,...
            'uvw');
    elseif strcmp(guiFields.rB_p,'Miller-Bravais (hkil)[UVTW]')
        planeParent = Miller(...
            guiFields.h_p,...
            guiFields.k_p,...
            guiFields.i_p,...
    ...
    if strcmp(guiFields.rB_c,'Miller (hkl)[UVW]')
        planechild = Miller(...
            guiFields.h_c,...
            guiFields.k_c,...
            guiFields.l_c,...
        ...
        directionchild = Miller(...
            ...
            job.csChild,...
            'uvw');
    elseif strcmp(guiFields.rB_c,'Miller-Bravais (hkil)[UVTW]')
        planechild = Miller(...
            guiFields.h_c,...
            guiFields.k_c,...
            guiFields.i_c,...
