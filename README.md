...
---
## How to use
- The library can be downloaded as a *zip* file and unpacked into the directory of your choice: [click here](https://github.com/frankNiessen/ORTools/archive/ORTools-1.0.zip) for the latest release
