...
##  Example scripts
The world of martensitic transformation analysis can be difficult to navigate. To help make the analysis transparent, accessible, and easy to comprehend, the **ORTools** library consists of plug-and-play functions. Example scripts are provided to help demonstrate these functions *in action*.
